...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    // from here.
    System.out.println("number of buckets is " + table.numBucket + ",number of entries is " + table.numEntry);
    System.out.println("Load Factor is " + (double)table.numEntry / (double)table.numBucket);
    System.out.println("Expected collisions: " + table.calExpCollision());
    System.out.println("Actual collisions: " + table.actualCollision());
  }
