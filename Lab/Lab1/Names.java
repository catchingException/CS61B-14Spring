 ...
 */
  public static void main(String arg[]) {
    ...
    System.out.println();//Part II: the first syntax error
    System.out.println(first + " " + middle + " " + last + " ");
    System.out.println(initials);
    System.out.println(last + ", " + first + " " + middle);
    System.out.println(last + ", " + first + " " + middleInit +".");
    System.out.println(first.toUpperCase() + " " + last.toUpperCase());////Part II: the second syntax error
    ...
    System.out.println("The character at index 3 in " + middle + " is " +
		       middle.substring(3,4));//Part III: fix the run-time error (java.lang.StringIndexOutOfBoundsException)
