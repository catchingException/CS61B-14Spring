        ...
        try { // Part I
            ...
            while (!command.equals("quit")) {
                try {
                  ...
                  command = bankApp.readLine("--> "); // Part Extra: move this line from * to here
                } 
                catch(IOException e) {
          	       System.err.println(e);
                } 
                catch(BadAccountException e) { // Part II
                  System.out.println("Error:  Couldn't find account number" );
                }
                catch(BadTransactionException e) { // Part III
                  System.out.println("Error:  It is no sense" );
                }
                //* the program go to here after finishing the catch clause
            }

        } catch (IOException e) { // Part I
            System.err.println(e);
        }
