...
public class VirtualTeller {
   ...
   *  @exception BadAccountException whenever an account cannot be found. // Part II 
   */
  private AccountData findAccount(int acct) throws BadAccountException { // Part II: add a "throws" statement
    AccountData account = (AccountData) accounts.find(acct);
    if (account == null)
      throw new BadAccountException(acct); // Part II: add a "throw" statement
    return account;
  }
