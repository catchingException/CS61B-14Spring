...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    // Part I
    DListNode insertAfterNode;
    DList myDList = (DList)myList;
    insertAfterNode = myDList.newNode(item, myDList, this, next); // next == this.next
    next.prev = insertAfterNode;
    next = insertAfterNode;
    myList.size++;
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    // Part I // After throws a exception, then immdiately getting us out of the method(routine)
      // so we do not need to add else {} here
    DListNode insertBeforeNode;
    DList myDList = (DList)myList;
    insertBeforeNode = myDList.newNode(item, myDList, prev, this);
    prev.next = insertBeforeNode;
    prev = insertBeforeNode;
    myList.size++;
